     ...
     <div id="preto" class="col-sm-4 d-none d-sm-block" ></div>
      ...
      <div id="formulario" class="col-sm-4 col-xs-12" >
          <img src="https://www.myddev.com/images/myd.png" height="80px"/>
                ...
                <label ><p id="dados">Dados do contato</p></label>
            ...
            <div class="form-group" >
              <label>E-mail</label>
              <input type="email" name="email" placeholder="E-mail para contato" id="email" class="form-control">
            </div>
            <div class="form-group">
              <label>cpf</label>
              <input type="number" name="cpf" placeholder="cadastro de pessoa física" id="cpf" class="form-control">
            </div>
