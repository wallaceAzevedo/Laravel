  ...
  <div class="container-fluid">
      <div id="azul" class="col-12">
           ...
           <nav>
            ...
            <div id="topo2"><a href="#serviços"><p id="pMenu"> serviços</p></a></div>            
    ...
    <div class="row">
        <div id="vermelho" class="col-sm-6 col-xs-12"> <a name="home1"><p>oi</p></a>
            <div id="artigo1" class="col-sm-10 col-xs-10" >
             <h1 id="artigo01">Faça Seus Sonhos Desenvolver</h1>
              <br/>
                <p>Ajudamos você a navegar no cenário tecnológico cada vez mais complexo. Ao enfrentar os projetos mais desafiadores, garantindo uma solução confiável, extremamente rápida, sua empresa poderá atingir objetivos ambiciosos.</p>
       ...
       <div class="row">
          <div id="cinza" class="col-sm-6 col-xs-12"><a name="serviços"><p></p></a>
           <div id="cinzaImg" class="col-sm-6 col-xs-12">
             ...
             <div id="textoImagem" class="col-sm-11 col-xs-12">
               <h3>Tornamos a Tecnologia Simples</h1>
               	<p id="cinzaa">Temos experiência em tecnologias de ponta:
...
AWS | Google Cloud | Docker | Kubernetes</p>
          ...
          <div id="verde" class="col-sm-6 col-xs-12">
              ...
              <img id="verdeImg1" class="col-sm-12 col-xs-12" src="https://www.myddev.com/images/consultancy.svg" height="75%" >	
          	 <div id="textoImagemVerde" class="col-sm-12 col-xs-12">
          	 	...
          	 	<p id="textoVerde">Você está tendo problemas com a falta de mão de obra em sua equipe? Você pode ter um desenvolvedor full-stack para trabalhar com sua equipe!</p>
          	 </div>
            </div>
          </div>
      </div>
     ...
     <div class="row">   
          ...
          <div id="roxo" class="col-sm-6 col-xs-12"><a name="hello"><p></p></a>
		          ...
		          <h1 id="texto04">	Nós somos especialistas em Backend, Frontend, Mobile and Cloud Native.</h1>

		            <p id="cinza2"> Temos uma equipe altamente qualificada, com mais de 20 anos no setor de tecnologia, fornecendo aplicativos altamente disponíveis e escaláveis para criar seu projeto com experiência.</p>
      ...
      <div class="row">
        ...
        <div id="preto" class="col-sm-6 col-xs-12"> <a name="contato"><p></p></a>
            ...
            <div id="ultomoTxt1" class="col-sm-12 col-xs-12">
          	  <p id="cinza2" > Esperamos ansiosamente suas idéias. Clique no botão abaixo que entraremos em contato com você hoje.</p>
    ...
    <div class="row" id="ouro">
          ...
          <p id="cinza3"> Desenvolvemos soluções tecnológicas inovadoras para alavancar seus negócios.</p>
          <p id="cinza4"> © 2020 MYDDev. todos os direitos reservados.</p>

        </div>
        <div id="rodape2" class="col-sm-3 col-xs-12">
        	 <h3 id="negrito"> Navegaçao </h3>
        	 <p id="cinza5">inicio</p>
        	 <p id="cinza6">Serviços</p>
        	 <p id="cinza7">sobre</p>

        </div>  
        <div id="rodape3" class="col-sm-3 col-xs-12">
          <h3 id="negrito">Localização</h3>
          <p id="cinza5">São Paulo</p>
